...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (newDegree >= 300 && newDegree <= 360)
    {
        maxTransB = newTrans.b;
        self.rotaionType = XLRotaionViewTypeMax;
        self.container.transform = CGAffineTransformMake(-0.494683,-0.869073,0.869073,-0.494683, 0, 0);
        self.temperatureLabel.text = @"32.0°";
        return;
    }
    else if (newDegree >= 40 && newDegree <= 180)
    {
        minTransB = newTrans.b;
        self.rotaionType = XLRotaionViewTypeMin;
        self.container.transform = CGAffineTransformMake(0.765179,0.643817,-0.643817,0.765179, 0, 0);
        self.temperatureLabel.text = @"16.0°";
        return;
    }
    self.container.transform = newTrans;
