...
- (void)initImageView
{
    ...
    [adviseImageView autoPinEdgesToSuperviewEdgesWithInsets:UIEdgeInsetsMake(15.0, 10.0, 0, 10.0) excludingEdge:ALEdgeBottom];
    [adviseImageView autoSetDimension:ALDimensionHeight toSize:150.0];
}
...
- (void)initContainer
{
    ...
    [container autoPinEdgesToSuperviewEdgesWithInsets:UIEdgeInsetsMake(190, 20, 0, 20) excludingEdge:ALEdgeBottom];
...
//    [self.wifiPassword setText:@"ds13439616555"];
